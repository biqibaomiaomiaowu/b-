...
from bilibili_media_webui import get_request_cookie_text, DEFAULT_BBDOWN
...
def test_explicit_cookie_empty_string():
    ...
    with patch("bilibili_media_webui.get_bbdown_data_candidates") as mock_candidates:
...
@patch("bilibili_media_webui.get_bbdown_data_candidates")
@patch("bilibili_media_webui.read_cookie_data_file")
